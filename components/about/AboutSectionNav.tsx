...
export interface AboutSectionNavItem {
  id: string;
  label: string;
}
...
/**
 * Sticky in-page "jump to section" nav for the single-page About experience.
 * Pure anchor links (no client routing needed) so it degrades gracefully
 * with JS disabled — the active-section highlight is a progressive enhancement.
 */
