...
import { StudentLifeSectionNav } from '@/components/student-life/StudentLifeSectionNav';

export const metadata: Metadata = {
  title: "Student Life",
  description:
    "Life beyond the classroom at Trafalgar High School — sport, culture and arts, clubs, student leadership, and school spirit.",
};

// Sporting codes — names withheld pending confirmation with the school.
// Do not invent which codes are currently offered; each slot is a template
// for the school to complete, not a factual claim.
const sportingCodes = [
  { title: "Sporting Code — Placeholder 1", body: "Placeholder — confirm code name, season, coaches and recent results." },
  { title: "Sporting Code — Placeholder 2", body: "Placeholder — confirm code name, season, coaches and recent results." },
  { title: "Sporting Code — Placeholder 3", body: "Placeholder — confirm code name, season, coaches and recent results." },
  { title: "Sporting Code — Placeholder 4", body: "Placeholder — confirm code name, season, coaches and recent results." },
];

// Categories named per the existing site's own Culture & Arts stub
// ("choir, drama, debate, and music") — not invented, just structured.
const cultureCategories = [
  { title: "Choir", image: "/placeholders/choir.svg", body: "Placeholder — describe the choir programme, performances and how to join." },
  { title: "Drama & Theatre", image: "/placeholders/assembly.svg", body: "Placeholder — describe drama productions, festivals and workshops." },
  { title: "Debating", image: "/placeholders/students-collaborating.svg", body: "Placeholder — describe the debating society, leagues entered and recent achievements." },
  { title: "Music", image: "/placeholders/students-collaborating.svg", body: "Placeholder — describe instrumental/vocal music offerings and ensembles." },
];

const clubs = [
  { title: "Club / Society — Placeholder 1", body: "Placeholder — confirm which clubs and societies currently run, and how learners join." },
  { title: "Club / Society — Placeholder 2", body: "Placeholder — confirm which clubs and societies currently run, and how learners join." },
  { title: "Club / Society — Placeholder 3", body: "Placeholder — confirm which clubs and societies currently run, and how learners join." },
  { title: "Club / Society — Placeholder 4", body: "Placeholder — confirm which clubs and societies currently run, and how learners join." },
  { title: "Club / Society — Placeholder 5", body: "Placeholder — confirm which clubs and societies currently run, and how learners join." },
  { title: "Club / Society — Placeholder 6", body: "Placeholder — confirm which clubs and societies currently run, and how learners join." },
];

const achievements = [
  { title: "Achievement — Placeholder", body: "Placeholder — add a recent sporting or cultural achievement once confirmed with the school." },
  { title: "Achievement — Placeholder", body: "Placeholder — add a recent sporting or cultural achievement once confirmed with the school." },
  { title: "Achievement — Placeholder", body: "Placeholder — add a recent sporting or cultural achievement once confirmed with the school." },
];
...
const faqs = [
  {
    ...
    answer: "Placeholder — confirm the sign-up process (e.g. through form teachers, trial dates, or a start-of-year activities fair).",
  },
  {
    question: "How are Prefects and the Head Boy/Girl selected?",
    answer: "Placeholder — confirm the school's current selection process for student leadership positions.",
  },
  {
    question: "Where can I find the full Code of Conduct?",
    answer: "Placeholder — confirm whether this is published under Policies or available on request from the school office.",
  },
];
  ...
  return (
    <>
      ...
      <PageHero
        ...
        title="Belonging, leadership and school spirit — beyond the classroom"
      ...
      <StudentLifeSectionNav items={sectionNavItems} />
        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_1fr] lg:items-center">
          <div>
            ...
            <p className="prose-body mt-4">
              Placeholder — expand with a fuller, current description of what a typical week outside the
      ...
      <section id="culture-arts" className="container-page scroll-mt-36 py-16 sm:py-20">
        <SectionHeading eyebrow="Culture & Arts" title="Nurturing creativity" description="Choir, drama, debate and music — categories carried over from the current site, details pending confirmation." />
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <section id="clubs" className="scroll-mt-36 bg-parchment-300/50 py-16 sm:py-20">
        <div className="container-page">
          <SectionHeading eyebrow="Clubs & Societies" title="Find your passion" description="Placeholder list — replace with the real, current clubs and societies once confirmed." />
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="prose-body mt-2 text-sm">
                Placeholder — names withheld pending confirmation with the school. Replace with the current Head
            ...
            <div>
              ...
              <p className="prose-body mt-2 text-sm">
                Placeholder — replace with the current prefect body once confirmed, including how prefects
            ...
            <div>
              ...
              <p className="prose-body mt-2 text-sm">
                Placeholder — describe the RCL's structure and current representatives once confirmed with the
                school.
              </p>
            </div>
            <div>
              ...
              <p className="prose-body mt-2 text-sm">
                ...
                club and society roles, peer mentoring, and event organising — building confidence that lasts
                well beyond matric.
              </p>
            </div>
          </div>
      ...
      <section id="experience" className="scroll-mt-36 bg-navy-900 py-16 sm:py-20">
        <div className="container-page">
          <div className="[&_*]:text-parchment-50">
            <SectionHeading eyebrow="What Makes Trafalgar Special" title="More than a school — a community" />
          </div>
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-xs border border-parchment-50/15 bg-navy-800/60 p-6">
              ...
              <p className="prose-body mt-2 text-sm text-parchment-200">
                ...
                school years — a hallmark of the Trafalgar community.
              </p>
            </div>
            <div className="rounded-xs border border-parchment-50/15 bg-navy-800/60 p-6">
              ...
              <p className="prose-body mt-2 text-sm text-parchment-200">
                ...
                responsibility by taking part — not just by watching.
              </p>
            </div>
            <div className="rounded-xs border border-parchment-50/15 bg-navy-800/60 p-6">
              ...
              <p className="prose-body mt-2 text-sm text-parchment-200">
                The same spirit captured in our motto — <em>Per Angusta, Ad Augusta</em> — shows up every time a
      ...
      <section id="code-of-conduct" className="container-page scroll-mt-36 py-16 sm:py-20">
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-[1.2fr_1fr] lg:items-start">
          <div className="prose-body max-w-2xl space-y-4">
            <p>
              Trafalgar expects every learner to act with respect, honesty and responsibility — towards
            ...
            <p>
              Placeholder — replace this overview with a concise summary of the school's actual, current Code
          ...
          <div className="rounded-xs border border-navy-800/10 bg-parchment-100 p-6 shadow-card">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-ink-muted">Placeholder — document not yet uploaded</p>
              </div>
            </div>
            <Link
              href="/policies"
      ...
      <section id="achievements" className="scroll-mt-36 bg-parchment-300/50 py-16 sm:py-20">
        <div className="container-page">
          <SectionHeading eyebrow="Recognising Success" title="Student Achievements" description="Placeholder highlights — replace with real, recent sporting and cultural achievements once confirmed." />
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <section id="gallery" className="container-page scroll-mt-36 py-16 sm:py-20">
        <SectionHeading eyebrow="A Glimpse" title="Student Life in pictures" description="A small preview — browse the full, categorised gallery for more." />
      ...
      <section id="faq" className="scroll-mt-36 bg-parchment-300/50 py-16 sm:py-20">
        <div className="container-page">
          <SectionHeading eyebrow="Questions" title="Frequently Asked Questions" description="Placeholder FAQs — replace or expand once confirmed with the school." />
      ...
      <CTASection
        ...
        description="Get involved in sport, culture, clubs or leadership — apply today to become part of the legacy. For questions, our team is happy to help."
